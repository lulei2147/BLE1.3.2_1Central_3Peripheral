    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR6_UUID:
        *pLen = simpleProfileChar6Len;
        ...
        NPI_PrintString("readAttrCB\r\n");
        {
          extern bool simpleBLESendDataEnable;
          extern uint8 simpleBLEPeripheralFlag;
          
          if(GET_BLE_WRITE_CYCLE_FLG() == TRUE)
          {
            SET_BLE_WRITE_CYCLE_EVT();
          }
          else
          {
